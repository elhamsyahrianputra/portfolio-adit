                                    ...
                                    <div class="block-main mb-30">
                                        ...
                                        <div class="text-center">
                                            <video class="img-responsive" autoplay controls>
                                                ...
                                                <source src="/assets/video/video1.mp4" type="video/ogg">
                                        ...
                                        <div class="content-main single-post padDiv">
                                            ...
                                            <p class="mb-30">It is a long established fact that a reader will be
                                                ...
                                                the like).</p>
                                            <p class="mb-30">Lorem Ipsum is simply dummy text of the printing and
                                            ...
                                            <blockquote>If you are still looking for that one person who will change
                                                your life, take a look in the mirror.</blockquote>
                                            <p class="mb-30">Contrary to popular belief, Lorem Ipsum is not simply
                                                    ...
                                                    <div class="entry-comments-item">
                                                        ...
                                                        <div class="entry-comments-body">
                                                            ...
                                                            <p class="mb-10">Lorem ipsum dolor sit amet, consectetur
                                                                adipiscing elit. Nunc quam justo, ullamcorper tincidunt
                                                                pellentesque in, condimentum ut enim. Aenean at pharetra
                                                    ...
                                                    <ul class="entry-comments-reply list-unstyled">
                                                        <li>
                                                            <div class="entry-comments-item">
                                                                ...
                                                                <div class="entry-comments-body">
                                                                    <span class="entry-comments-author">Sara
                                                                        Smith</span>
                                                                    <span><a href="#">fev 14, 2018 at 12:51
                                                                            pm</a></span>
                                                                    <p class="mb-10">Lorem ipsum dolor sit amet,
                                                                        consectetur adipiscing elit. Nunc quam justo,
                                                                        ullamcorper tincidunt pellentesque in,
                                                                        condimentum ut enim. Aenean at pharetra diam,
                                                                        quis vulputate urna.</p>
                                                                    <a class="rep" href="#">Reply</a>
                                                                </div>
                                                            </div>
                                                        </li>
                                    ...
                                    <div class="cmt padDiv">
                                        <form id="comment-form" method="post" action="" role="form">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input id="form_name" type="text" name="website"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <textarea id="form_message" name="message" class="form-control"
                                                            placeholder="Message *" style="height: 200px;"
